...
const projectGeomsXML = (queryFilters: string) => [
...
export class GeometryService {
  ...
  async createAnonymousMapWithFilters(filters: string) {
    const blocks = await this.getBlocksFromXMLQuery(filters);
  ...
  async getBlocksFromXMLQuery(filters: string) {
    try {
