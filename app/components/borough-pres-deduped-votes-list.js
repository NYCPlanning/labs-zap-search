...
export default class DedupedVotesListComponent extends Component {
  ...
  get dedupedVotes() {
    ...
    function checkAllFields(date, recType) {
      if (date !== null) {
    ...
    const newDispositionsArray = this.dispositions.map(disp => ({
      ...
      dispHasAllFields: checkAllFields(disp.dcpDatereceived, disp.dcpBoroughpresidentrecommendation),
