...
export const actions = [
  ...
  ['CS', 'Substantial Compliance review occurs to verify if small changes to a proposed project are compliant with the original approval (e.g. slight adjustments to dimensions on an approved site plan that do not create a zoning non-compliance).'],
  ...
  ['LD', 'Legal Document (NOC, NOR, RD)', 'An LD action indicates that a project has one or more additional actions related to associated legal documents that impose additional property controls beyond zoning regulations. Such additional actions could be, for example, that a legal document is being created or modified, or that there is a follow-up approval pursuant to an existing legal document being processed. The different types of legal documents include "Notice of Certification" (NOC), "Notice of Restrictions" (NOR), and "Restrictive Declaration" (RD).'],
